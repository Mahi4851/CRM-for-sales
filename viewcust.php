...
$result = mysqli_query($conn, $query);
		...
		while ($row = mysqli_fetch_array($result))
		{
			...
			echo "<td><a href=\"emptask.php?id=$row[id]\">Task View</a> |<a href=\"custedit.php?id=$row[id]\">Edit</a> | <a href=\"custdelete.php?id=$row[id]\" onClick=\" return confirm('Are you sure ,you want to delete?')\">Delete</a></td>";
