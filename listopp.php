...
<table>	<tr><th><a href="Exportoppo.php"><input  type="submit" name="button" value="Export to Excel"></a> </th><th></th><th></th>

			
			<th><form action="oppoPDF.php" method="post" ><input type="submit" name="submit" value="Export to PDF"></button> </th></tr></table>
