...
<table>	<tr><th><a href="Exporttask.php"><input  type="submit" name="button" value="Export to Excel"></a> </th><th></th><th></th>

			
			<th><form action="taskPDF.php" method="post" ><input type="submit" name="submit" value="Export to PDF"></button> </th></tr></table>
...
$query = "select crm_tasks.*, crm_contact.company
        ...
        INNER JOIN crm_contact ON crm_tasks.contact = crm_contact.id
         WHERE crm_tasks.sales_rep = '$eml' $whereClause LIMIT $offset, $limit ";
