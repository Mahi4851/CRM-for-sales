...
<table>	<tr><th><a href="Exportcust.php"><input  type="submit" name="button" value="Export to Excel"></a> </th><th></th><th></th>

			
			<th><form action="custPDF.php" method="post" ><input type="submit" name="submit" value="Export to PDF"></button> </th></tr></table>
...
$whereClause = ($searchValue != '') ? "AND (
 ...
 $result=mysqli_query($conn,"select COUNT(*) as total from crm_contact where Emp_Email='$eml' AND status='Customer' $whereClause");
...
$query = "SELECT * FROM crm_contact  where Emp_Email='$eml' AND status='Customer' $whereClause LIMIT $offset, $limit ";
