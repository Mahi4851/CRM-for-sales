...
$qry8=mysqli_query($conn,"SELECT DISTINCT Ind_Type  FROM  crm_industry WHERE Ind_Type <> '$industry'");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Customer Entry Form</strong>
                            </div>
                            <div class="card-body card-block">


                                <form action="AddCust.php" method="post"  name="frm" id="frm" onSubmit="return checkemail()" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="last" id="t4" placeholder="Enter Last Name" size="25" required autofocus maxlength="25"  onblur="valid2()" onfocus="valid2()" onclick="valid2()"  class="form-control"></div>
                                    </div>
   ...
   <div class="row form-group">
    ...
    <div class="col-12 col-md-9"><input  type="text" name="company"  placeholder="Enter Company Name" onblur="valid1()" onfocus="valid1()" onclick="valid1()" maxlength="150" required autofocus class="form-control"></div>
                                    </div>
               ...
               <option> Select Industry</option> 
                    <?php
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="email" id="eml" name="email" maxlength="50" required  placeholder="Enter Company Email" onfocusout="return checkbae()" autofocus class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input  type="text" name="website" id="websiteInput"  autofocus placeholder="Enter Company Website"  maxlength="50" required class="form-control"></div>
                                    </div>
...
if ($city === 'other') {
        ...
        $result=mysqli_query($conn,"insert into crm_contact (Emp_Email,contact_first,contact_last,company,industry,budget,email,mobile,LandLine,website,state,district,city,address,country,status) values ('$user','$first','$last','$company','$industry','$budget','$email','$mobile','$landline','$website','$state','$district','$city','$address','INDIA','Customer')");

        echo '<script>alert("Your Information Successfully Submited")</script>';
        echo "<script>window.location.href='AddCust.php';</script>";
        return false;
