...
<body>
 ...
 <div class="content">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Lead List Report</strong>
		...
		<table>	<tr><th><a href="Export.php"><input  type="submit" name="button" value="Export to Excel"></a> </th><th></th><th></th>

			
			<th><form action="generatePDF.php" method="post" ><input type="submit" name="submit" value="Export to PDF"></button> </th></tr></table>
