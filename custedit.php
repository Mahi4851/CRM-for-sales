...
$result =mysqli_query($conn,"UPDATE crm_contact SET  contact_first='$contact_first',contact_last='$contact_last', company='$company',industry='$industry', mobile='$mobile',LandLine='$landline',email='$email',website='$website',status='$status',state='$state',district='$district',city='$city',address='$address',zip='$zip',budget='$budget' WHERE id=$id");


echo '<script>alert("Your Information Successfully Updated")</script>';
        echo "<script>window.location.href='viewcust.php';</script>";
        return false;
    }
?>
...
<form action="custedit.php" method="post"  name="frm" id="frm" onSubmit="return checkemail()" enctype="multipart/form-data" class="form-horizontal">
...
<input type="hidden" name="id" value="<?php echo $id; ?>">
            ...
            <div class="col-12 col-md-9"><input type="text" name="contact_last" id="t4" placeholder="Enter Last Name" size="25" required autofocus maxlength="25" value="<?php echo $contact_last; ?>" onblur="valid2()" onfocus="valid2()" onclick="valid2()"  class="form-control"><span id="nm3"></span></div>
             ...
             <div class="row form-group">
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><select name="industry" required autofocus placeholder="Enter Company/Industry Type" class="form-control">
                   ...
                   while($row1=mysqli_fetch_array($qry8))
                 {
                   echo"<option>".$row1[0]."</option>";        }     ?>
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input  type="tel" name="budget" id="budget"  required autofocus placeholder="Enter Budget "  maxlength="10" value="<?php echo  $budget  ?>"  onkeyup="number1(this)"  class="form-control"></div>
                                    </div>
        ...
        <div class="col-12 col-md-9"><input type="tel" name="landline" required placeholder="Enter Company Landline No." value="<?php echo $landline; ?>" autofocus maxlength="15" onkeyup="number1(this)" class="form-control"></div>
         ...
         <div class="row form-group">
          ...
          <div class="col-12 col-md-9"><input type="email" id="eml" maxlength="50" name="email" required  placeholder="Enter Company Email" value="<?php echo $email; ?>" onfocusout="return checkbae()" autofocus class="form-control"></div>
            </div>
            ...
            <div class="col-12 col-md-9">
                <input type="text" name="city1" placeholder="Enter your City" class="form-control" maxlength="25">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="tel" name="zip"  required placeholder="Enter ZIP Code" maxlength="6"  onkeyup="number1(this)" value="<?php echo $zip; ?>"   autofocus class="form-control" onkeypress=" isInputNumber(evt)" ></div>
                                    </div>
