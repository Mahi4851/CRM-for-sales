...
<body>
 ...
 <div class="content">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Pending Task List</strong>
	...
	<table>	<tr><th><a href="pendingxl.php"><input  type="submit" name="button" value="Export to Excel"></a> </th><th></th><th></th>

			
			<th><form action="pendingPDF.php" method="post" ><input type="submit" name="submit" value="Export to PDF"></button> </th></tr></table>
...
$countQuery = "select COUNT(*) as total FROM crm_tasks INNER JOIN crm_contact ON crm_tasks.contact = crm_contact.id WHERE crm_tasks.sales_rep = '$eml' and crm_tasks.task_status='Pending' $whereClause";
...
$query = "select crm_tasks.*, crm_contact.company
        ...
        INNER JOIN crm_contact ON crm_tasks.contact = crm_contact.id
         WHERE crm_tasks.sales_rep = '$eml' and crm_tasks.task_status='Pending' $whereClause LIMIT $offset, $limit ";
